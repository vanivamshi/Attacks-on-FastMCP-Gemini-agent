...
class SecurityGuardrails:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.enable_jailbreak_detection = self.config.get("enable_jailbreak_detection", True)
    ...
    def check_code_safety(self, code: str) -> Tuple[bool, str]:
        ...
        if re.search(r'(socket|urllib|requests|httpx)', code_lower):
            return False, "Network operations are blocked for security"
        
        # Check for environment variable access (sensitive)
        if re.search(r'getenv|environ', code_lower):
            return False, "Environment variable access is blocked for security"
